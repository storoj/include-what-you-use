...
string GetInclusionKindAsString(InclusionDirective::InclusionKind kind) {
  ...
  switch (kind) {
    case InclusionDirective::Include: return "#include";
    case InclusionDirective::Import: return "#import";
    case InclusionDirective::IncludeMacros: return "#__include_macros";
    case InclusionDirective::IncludeNext: return "#include_next";
  }
...
bool OneIncludeOrForwardDeclareLine::IsIncludeLine() const {
  ...
  return StartsWith(line_, internal::GetInclusionKindAsString(InclusionDirective::Include)) || 
         StartsWith(line_, internal::GetInclusionKindAsString(InclusionDirective::Import));
}
  ...
  for (const OneUse& use : uses) {
    ...
    if (use.is_full_use()) {
      ...
      if (!Contains(*lines, use.suggested_header())) { // must be added
        ...
        InclusionDirective::InclusionKind inclusion_kind = InclusionDirective::Include;
        const IncludePicker& picker = GlobalIncludePicker();   // short alias
