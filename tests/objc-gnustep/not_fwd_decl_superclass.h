...
tests/objc-gnustep/not_fwd_decl_superclass.h should add these lines:

tests/objc-gnustep/not_fwd_decl_superclass.h should remove these lines:
- @class ImportedClass;  // lines XX-XX

The full include-list for tests/objc-gnustep/not_fwd_decl_superclass.h:
