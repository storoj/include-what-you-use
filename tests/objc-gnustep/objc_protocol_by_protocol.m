//===--- objc_protocol_by_protocol.m - test input file for iwyu -----------===//
//
...
// Tests that if protocol conforms to another protocol, it requires full
// protocol use.
...
(tests/objc-gnustep/objc_protocol_by_protocol.m has correct #includes/fwd-decls)
