...
tests/objc-gnustep/fwd_decl_class_as_ivar.h should add these lines:
@class ImportedClass;

tests/objc-gnustep/fwd_decl_class_as_ivar.h should remove these lines:
- #import "imported_class.h"  // lines XX-XX

The full include-list for tests/objc-gnustep/fwd_decl_class_as_ivar.h:
