...
tests/objc-gnustep/move_import.h should add these lines:
@class Bar;

tests/objc-gnustep/move_import.h should remove these lines:
- #import "objc_call_instance_method-i1.h"  // lines XX-XX

The full include-list for tests/objc-gnustep/move_import.h:
