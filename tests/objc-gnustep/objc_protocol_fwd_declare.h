...
tests/objc-gnustep/objc_protocol_fwd_declare.h should add these lines:
@protocol FooProtocol;

tests/objc-gnustep/objc_protocol_fwd_declare.h should remove these lines:
- #import "objc_protocol.h"  // lines XX-XX

The full include-list for tests/objc-gnustep/objc_protocol_fwd_declare.h:
