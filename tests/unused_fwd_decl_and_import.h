...
tests/unused_fwd_decl_and_import.h should add these lines:

tests/unused_fwd_decl_and_import.h should remove these lines:
- #import "tests/imported_class.h"  // lines XX-XX
- @class ImportedClass;  // lines XX-XX

The full include-list for tests/unused_fwd_decl_and_import.h:
